...
<body>
    <div class="container-fluid bg-info pb-2">
        ...
        <img class="img-fluid" id="logo" src="assets/img/lumen.png" width="170" style="position: absolute; right:10px; margin-top: 15px; border-radius: 100%; border-style: solid; border-color: white">
        <div class="row">
